...
export function ReserveNowSection() {
    return (
        <div className="relative bg-[url('/residence-pierre-vacances-la-corniche-d-or.png')] bg-cover bg-center py-12 min-h-screen flex flex-col items-center justify-center z-10">
            {/* overlay */}
