...
export function ReserveNowSection() {
    return (
        <section className="relative bg-[url('/residence-pierre-vacances-la-corniche-d-or.avif')] bg-cover bg-no-repeat bg-center py-12 min-h-screen flex flex-col items-center justify-center">
            {/* Overlay */}
