    ...
    return (
        <div className="bg-[url('/pic-de-lourse-background.avif')] bg-cover bg-no-repeat bg-center min-h-screen">
            <div className="w-11/12 lg:w-3/4 mx-auto z-10 py-16 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-0">
                ...
                {/* Description */}
                <div className="max-w-full md:max-w-[600px] text-center md:text-right">
                    <h2 className="font-normal text-primary-foreground">
                        Un point de départ idéal pour <span className="font-bold mt-2 block md:inline">découvrir la Côte d’Azur !</span>
                    </h2>
                    <p className="text-sm sm:text-base font-normal text-primary-foreground text-justify pt-4 md:pt-10">
