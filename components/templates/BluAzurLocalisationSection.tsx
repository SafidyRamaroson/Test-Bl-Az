        ...
        <div className="bg-[url('/blu-azur-localisation-background.png')] min-h-screen bg-cover bg-center py-24">
            ...
            <div className="w-3/4 mx-auto grid grid-cols-2 gap-[234px] justify-center items-center">
                ...
                <div className="text-justify text-[#121212] mb-[21px]">
                    <h2 className="text-[34px] font-normal">Où se trouve Blu Azur à <br /> <span className="font-bold">Saint-Raphaël ?</span> </h2>
                    ...
                    {/* how to get there */}
                    <Button size='lg' className="border border-primary text-primary hover:text-primary-foreground hover:border-primary-foreground cursor-pointer bg-white rounded-full">
                        Comment s&apos;y rendre
