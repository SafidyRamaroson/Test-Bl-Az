...
export function HeroText() {
    return (
        <div className="relative lg:max-w-[422px] min-h-screen mx-auto flex flex-col justify-center items-start z-10">
            ...
            <p className="text-sm text-justify text-primary-foreground mt-4">
                ...
                destination d&apos;exception nichée entre Cannes et Saint-Tropez.
                Nos appartements tout équipés, situés dans un domaine privé
            ...
            <Button className="px-8 py-5 rounded-full mt-16 bg-transparent border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary cursor-pointer flex items-center justify-center gap-2">
                <span className="whitespace-normal break-words text-center">Réservez dès maintenant votre séjour !</span>
